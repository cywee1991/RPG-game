...
while running:
    ...
    #Check if enemy won
        ...
        print(bcolors.WARNING + "Your enemies have defeated you!" + bcolors.ENDC)
        running = False
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == "white":
                player.heal(magic_dmg)
                print(bcolors.OKBLUE + "\n" + enemy.name.replace(" ","") + "use" + spell.name + "and heals " + enemy.name + "for", str(magic_dmg), "HP" + bcolors.ENDC)
            elif spell.type == "black":
                ...
                print(bcolors.OKBLUE + "\n" + enemy.name.replace(" ","") + " use " + spell.name + " and " + " deals", str(magic_dmg),
